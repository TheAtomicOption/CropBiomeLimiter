...
public final class ViewerAtlasSmokeTest {
	...
	private static void customDimensionsUseTheLocalBiomeRegistry() {
		ResourceKey<Level> moon = ResourceKey.create(Registries.DIMENSION, Identifier.parse("example:moon"));
		Identifier wheat = Identifier.parse("minecraft:wheat");
	...
	private static void mixedModesBuildBothLookupDirections() {
		Identifier wheat = Identifier.parse("minecraft:wheat");
		Identifier carrots = Identifier.parse("minecraft:carrots");
	...
	private static CropAtlasEntry cropEntry(CropBiomeAtlas atlas, net.minecraft.resources.ResourceKey<Level> dimension, Identifier crop) {
