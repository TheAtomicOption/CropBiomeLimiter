...
public final class CropBiomeLimiterJeiPlugin implements IModPlugin {
	...
	public static final RecipeType<CropAtlasPage> CROP_ATLAS = RecipeType.create(
			CropBiomeLimiter.MOD_ID,
			"crop_atlas",
			CropAtlasPage.class
	);
	public static final RecipeType<BiomeAtlasPage> BIOME_ATLAS = RecipeType.create(
			CropBiomeLimiter.MOD_ID,
			"biome_atlas",
	...
	public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
		registration.addRecipeCatalysts(BIOME_ATLAS, Items.COMPASS);
	}
